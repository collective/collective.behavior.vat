...
project = u'collective.behavior.vat'
...
htmlhelp_basename = 'collective.behavior.vatdoc'
...
latex_documents = [
  ('index', 'collective.behavior.vat.tex', u'collective.behavior.vat Documentation',
...
man_pages = [
    (
        'index',
        'todo',
        u'collective.behavior.vat Documentation',
        [u'Taito Horiuchi'],
        1)]
